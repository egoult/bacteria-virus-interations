...
CreateBacteriaxVirusmod<-function(){
  ...
  po <- pomp(data = data.frame(time = seq(from = 0., to = 400, by = 0.05), X = NA),
             ...
             paramnames = c("R0_bac", "R0_vir",
                            ...
                            "eta1", "eta2",                           
                            "E0", "C0", "theta"), 
             params = c(R0_bac = 0.6, R0_vir = 3, # 2.5  change R0 to c star =  fixed point colonisation
                        w1=1, w2=1, 
                        v1=1, v2=1, v3=1, v4=1, 
                        delta1 = 1/50 , delta2 = 1/50, delta3 = 1/50, delta4 = 1/50, # varying 
                        gamma1 = 1/4, gamma2 = 1/4, # 6 days
                        ...
                        # eta1 = 0.7, eta2 = 0.7,
                        eta1 = 1, eta2 = 1,
                        E0 = 10^-5, C0 = C star, theta = 1), # check different values of E0
